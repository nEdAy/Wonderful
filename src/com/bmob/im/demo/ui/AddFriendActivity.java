...
import com.stone.shop.adapter.AddFriendAdapter;
import com.xgr.wonderful.R;
import com.xgr.wonderful.utils.CollectionUtils;
...
public class AddFriendActivity extends ActivityBase implements OnClickListener,IXListViewListener,OnItemClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(com.xgr.wonderful.R.layout.activity_add_contact);
		initView();
	}
	...
	public void onClick(View arg0) {
		// TODO Auto-generated method stub
		switch (arg0.getId()) {
		case com.xgr.wonderful.R.id.btn_search://搜索
			users.clear();
